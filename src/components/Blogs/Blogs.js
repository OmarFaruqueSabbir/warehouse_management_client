        ...
        <div>
            <section class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-12 mx-auto">
                    <h1 class="text-3xl leading-8 font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl ">Blog Sections.</h1>

                    <div class="grid grid-cols-1 gap-8 mt-8 lg:mt-16 md:grid-cols-2 ">
                        <div>
                            <div class="inline-block p-3 text-white bg-indigo-500 rounded-lg">
                            ...
                            <div>
                                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">Difference between Javascript and Nodejs?</h1>

                                <p class="mt-2 text-sm text-justify text-gray-500 dark:text-gray-300">
                        ...
                        <div>
                            ...
                            <div>
                                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">When should we use Nodejs and Mongodb?</h1>

                                <p class="mt-2 text-justify text-sm text-gray-500 dark:text-gray-300">
                        ...
                        <div>
                            ...
                            <div>
                                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">Differences between SQL and NoSQL databases?</h1>
                        ...
                        <div>
                            ...
                            <div>
                                <h1 class="text-xl font-semibold text-gray-700 dark:text-white">What is the purpose of JWT and how does it work?</h1>
                                <p class="mt-2 text-sm text-justify text-gray-500 dark:text-gray-300">
