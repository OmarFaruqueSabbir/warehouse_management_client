            ...
            <div className="container px-5 py-16 mx-auto">
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                        ...
                        <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">Introducing our three Ware-Houses to store,stock & manage logistics & products. All of our warehouses are well-built and well-structured with modern warehouse setups & facilities.</p>
                    </div>
                </div>
