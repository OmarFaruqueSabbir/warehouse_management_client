        ...
        <div className='shadow-lg rounded-2xl w-[350px] bg-white p-4 mt-3 mb-5'>
            <div className='gap-4 flex flex-col justify-between items-center'>
                ...
                <div className=' flex flex-col justify-end'>
                    ...
                    <button onClick={() => handleItemDetail(_id)} className="flex mx-auto mt-5 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Update Button</button>
                </div>
            </div>
        </div>
    );
